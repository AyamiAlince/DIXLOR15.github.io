...
const commands = {
	...
	{
		cmd: 'aboutme',
		res: 'About Me:<br># <span class="blue">Real Name:</span> Дмитрий<br># <span class="blue">Born:</span> ' + sMonth["2"] + ' 13 2003 <span class="blue">(Age: ' + GetAge("2003-03-13") + ')</span><br># <span class="blue">Country:</span> Russia<br><br>Bio:<br># <span class="blue">Programming:</span> HTML, Python, C++.<br># <span class="blue">Languages:</span><br>- Russian <span class="blue">(National)</span><br>- English <span class="blue">(Intermediate)</span>'
	},
	links: 
	{
		cmd: 'links',
		res: 'Links:<br># <span class="blue"><a href="https://www.youtube.com/channel/UCVgtDoxCS1juwYTZHGDSlMA" target="_blank"><u>YouTube</u></a></span> - My YouTube channel.</a></span><br># <span class="blue"><a href="https://vk.com/Dixlor5" target="_blank"><u>VK</u></a></span> - You can find me there <span class="green">Online</span> most of the time. <br># <span class="blue"><a href="https://github.com/Dixlor15" target="_blank"><u>Github</u></a></span> - Some trash code, I post there.<br># <span class="blue"><a href="https://onetap.su" target="_blank"><u>OneTap</u></a></span> - OTV4 top'
	},
	visitors: 
	{
		cmd: 'visitors',
...
var prephraseRoot = '<span class="blue">root@DixlorV.design</span>:<span class="blue">~</span># ';
var prephrase = '<span class="blue">visitor@DixlorV.design</span>:<span class="blue">~</span># ';
...
{
	var res = '';
	if (command === './welcome.sh') res = 'Welcome to <span class="blue">DixlorV.design</span>!<br><br>You\'re visiting from: <span class="blue">' + visitorCountry + '</span><br>Last 5 Country Visits: <span class="blue">' + lastCountry0 + '</span>, <span class="blue">' + lastCountry1 + '</span>, <span class="blue">' + lastCountry2 + '</span>, <span class="blue">' + lastCountry3 + '</span>, <span class="blue">' + lastCountry4 + '</span>.<br>Total Visits: <span class="blue">' + visits + '</span><br>Terminal Updated: <span class="blue">' + lastUpdate +'</span><br><br><b>Type \'help\' for more details on the commands</b>'
	else
	{
...
$('form').on('submit', function(e) {
	...
	try {
			...
			if (vInput.startsWith("./")) {
				if (vInput === "./root/welcome.sh") {
					...
					launchCommandAsVisitor({
						cmd: vInput,
						res: '<div><p>DixlorV.design: ' + vInput + ': No such file or directory</p></div>'
					});
				}
				...
				if (typeof loginArray[2] !== "undefined") {
					if (loginArray[2] === "visitor") {
						...
						res = 'DixlorV.design: No passwd entry for user ' + loginArray[2] + '';
					}
					launchCommandAsVisitor({
				...
				if (vInput === "music play") {
					...
					launchCommandAsVisitor({
						cmd: vInput,
						res: '<div><p>[ <span class="blue">DixlorV.design</span> ] Usage: music [play/stop/link]</p></div>'
					});
				}
				...
				if (vInput === "friend joffrey") {
					...
					launchCommandAsVisitor({
						cmd: vInput,
						res: '<div><p>[ <span class="blue">DixlorV.design</span> ] Usage: friend [name/list]</p></div>'
					});
				}
		...
		if (root > 0) {
			launchCommandAsRoot({
				cmd: $('input').val(),
				res: '<div><p>DixlorV.design: ' + $('input').val() + ': command not found</p></div>'
			});
		} else {
			launchCommandAsVisitor({
				cmd: $('input').val(),
